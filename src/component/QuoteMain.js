...
export const QuoteMain = () => {
  return (
    <div className="quote-main">
         ...
         <QuoteCart
            description={"The most remarkable thing about my mother is that for thirty years she served the family nothing but leftovers. The original meal has never been found."}
            author={"Epictetus"}>
         </QuoteCart>
         <QuoteCart
         ...
         <QuoteCart
            description={"My ability to tolerate shame, to compartmentalize it, to swallow it, increased right along with my belt size. it came with the territory of being heavy. Obese people have a lifetime of experience with shame."}
            author={"Fran Lebowitz"}>
         </QuoteCart>
         <QuoteCart
         ...
         <QuoteCart
            description={"Preach not to others what they should eat, but eat as becomes you, and be silent."}
            author={"George Dennison Prentice"}>
         </QuoteCart>
         <QuoteCart
            description={"I have never cared much for fish - it floats in the belly as much as in the pond."}
            author={"Henry Bromel"}>
         </QuoteCart>
         <QuoteCart
         ...
         <QuoteCart
            description={"Food is an important part of a balanced diet."}
            author={""}>
         </QuoteCart>
         <QuoteCart
